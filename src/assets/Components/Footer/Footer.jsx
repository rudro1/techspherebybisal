...
const Footer = () => {
 ...
 <div className='flex  flex-col items-center    z-1 '>
        <div className='w-10/12 mx-auto flex flex-col items-center space-y-3 md:space-y-5'>
            <div className=" text-3xl md:text-5xl font-extrabold text-center leading-10 md:leading-15">    <a className=" font-extrabold border-b-1 rounded-b-full  tracking-wider text-xl animate-pulse ">TechSphere</a></div>
        ...
        <footer className=" md:flex justify-between w-11/12 mx-auto  text-base-content p-10">
  <nav className='flex flex-col md:gap-y-3 items-start '>
  ...
  <nav className='flex flex-col md:gap-y-3  md:items-start '>
